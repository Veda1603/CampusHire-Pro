...
public class ApplicationService {
    ...
    throw new RuntimeException(
        ...
        emailService.sendEmail(
                ...
                student.getUser().getFullName() + " applied for " + job.getTitle() + " position."
        );
    ...
    public ApplicationResponse updateApplicationStatus(Long id, String status) {
        ...
        notificationService.createNotification(
                ...
                "Your application for " + application.getJob().getTitle() + " updated to " + application.getStatus(),
                NotificationType.APPLICATION_UPDATE
        );
        ...
        emailService.sendEmail(
                ...
                "Your application for " + application.getJob().getTitle() + " has been updated to " + application.getStatus()
        );
    ...
    public ApplicationStatsResponse getApplicationStats() {
        ...
        response.setApplied(applications.stream().filter(app -> app.getStatus() == ApplicationStatus.APPLIED).count());
        response.setShortlisted(applications.stream().filter(app -> app.getStatus() == ApplicationStatus.SHORTLISTED).count());
        response.setRejected(applications.stream().filter(app -> app.getStatus() == ApplicationStatus.REJECTED).count());
